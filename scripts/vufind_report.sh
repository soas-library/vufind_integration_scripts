...
tail -100 /home/vufind/logs/vufind_main_run.log | mailx -s "Report log $(hostname)" againzarain@scanbit.net itsupport@scanbit.net 
...
mailx -s "System State $(hostname)"  againzarain@scanbit.net itsupport@scanbit.net ft9@soas.ac.uk bj1@soas.ac.uk < /tmp/report.txt